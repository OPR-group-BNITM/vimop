...
rule all:
  input:
    ...
    [CONSENSUS_PATH +'/{sample_no_blast}/{RUNID}-{sample_no_blast}-noblast-{covlimit}-consensus.csv'.format(RUNID=RUNID, covlimit=covlimit, sample_no_blast=sample_no_blast) for sample_no_blast in SAMPLES_NOBLAST]
