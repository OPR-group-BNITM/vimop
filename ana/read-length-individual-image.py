...
ax.set_xlabel('Length', size=15,weight='bold')
ax.set_ylabel('Number of reads', size=15,weight='bold')
...
ax.set_title('Run: '+str(snakemake.params.RUNID)+"\n sample: "+str(snakemake.params.sample), fontdict={'fontsize': 18, 'fontweight': 'bold'})
